 ...
 * @return undefined
 */
Method.method('generate', function (statuses) {
 ...
 * @return undefined
 */
Resource.method('generate', function () {
    var methods = this._methods;
 ...
 * is extensible by nature.
 *
 * @param affordances should be an Array of Affo
 *
 * @return undefined
 */
...
program
    ...
    .option('-q, --quiet', 'Use this flag when you would not like to see debug logs in the console.')
    .parse(process.argv);
