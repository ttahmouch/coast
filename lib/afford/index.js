...
/**
 * Evaluate whether api.getAffordances() should return an Affordances instance from XHN.
 */
fs.writeFileSync(folder + 'actions.json', JSON.stringify(api.getAffordances(true), null, '    '));
