    ...
    .action(function (res, met, ret) {
        ...
        if (!!met) {
            ...
            if (!!res) {
                ...
                if (!!met) {
                    /**
                     * Define and invoke a generate method on Method.
                     */
                    console.log('Define and invoke a generate method on Method.');
                    console.log('Generate for ' + ((!!ret) ? ret.toString() : 'all') + ' status code(s).');
                } else {
             ...
             */
            if (!!res) {
                console.log('Define and invoke a generate method on Resource.');
            } else {
                console.log('A valid, existent resource from your API should be entered. An example: /uri');
            }
        } else {
            console.log('Define and invoke a generate method on Resources.');
        }
    });
