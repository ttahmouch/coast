...
Relations.method('exists', function (rel) {
    /**
     * The _relations field of any instance of Relations can be inferred as an Array instance. It is a literal. Nothing
     * dynamic is done to it.
     * @type {Array}
     */
    var relations = this._relations;
    /**
     * If the relation exists in the defined array literal, then the returned index should not be -1.
     * Else, if the returned index is -1, then the relation does not exists, and furthermore, is not
     * acknowledged by IANA.
     */
