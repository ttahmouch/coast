...
input.canRevive = function (object) {
    ...
    return !!object &&
        ...
        typeof object._required === 'boolean' &&
        Array.isArray(object._accept);
};
...
input.revive = function (object) {
    /**
     * If the argument is an Object, then create an instance of Input and attempt to copy the arguments fields to the
     * instance.
     */
