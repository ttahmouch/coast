...
module.exports.hapi = exports.hapi = require('./hapi.js');
module.exports.input = exports.input = require('./input.js');
module.exports.message = exports.message = require('./message.js');
module.exports.messages = exports.messages = require('./messages.js');
