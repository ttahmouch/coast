 ...
 *
 * @param id is an optional argument. It is a globally unique String representation of an ID for the method instance
 * in the API specification. This will be the ID associated with the Method if it is being serialized in a hypermedia
 * control.
 *
 * @return {*}
 * @constructor
 */
function Method(jsonObjectOrMethodString, arguments, returns, id) {
    this._class = 'method';
    this._id = (typeof id === 'string') ? id : undefined;
    ...
    if (typeof jsonObjectOrMethodString === 'object') {
        /**
         * Get a reference to the Method ID if it exists. This may be undefined.
         * @type {String}
         */
        this._id = jsonObjectOrMethodString._id;
        /**
        ...
        /**
         * Get a reference to the static codes Array.
         * @type {Array}
         */
 ...
 */
function method(jsonObjectOrMethodString, arguments, returns, id) {
    return new Method(jsonObjectOrMethodString, arguments, returns, id);
}
